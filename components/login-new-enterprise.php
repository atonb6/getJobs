            ...
            <div class="col-md-8">
                <form action="dash-enterprise-home.php">
                    <div class="card login__card">
                        <h1 class="login__card__title">Crear Empresa</h1>
                        <h5 class="login__card__subtitle">Ingrese sus datos</h5>

                        <fieldset class="login__card__fieldset d-flex flex-column text-center mx-auto mt-3">

                            <div class="row text-left">
                                <div class="col-md-6">
                                    <input class="mt-3" type="text" placeholder="Nombre Empresa"  required>
                                    <input class="mt-3" type="text" placeholder="Rut Empresa"  required>
                                    <input class="mt-3" type="email" placeholder="Email"  required>
                                    <input class="mt-3" type="email" placeholder="confirmar Email"  required>
                                </div>
                                <div class="col-md-6">
                                    <input class="mt-3" type="text" placeholder="Giro"  required>
                            ...
                            <button type="submit" class="btn btn--blue mx-auto mt-3 mb-3">Crear Empresa</button>
