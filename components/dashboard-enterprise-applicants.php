...
<?php include('components/breadcrumb.php') ?>
    <h1 class="dashboard__profile__title mt-3 black ">Listado de postulantes (título de cargo)</h1>
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="row align-items-center mt-3">
                    <div class="col-md-6">
                        <div class="dashboard__enterprise__applicants__info__box">
                            ...
                            <h3><strong>Sueldo Promedio postulantes: </strong>$600.000</h3>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <label class="dashboard__profile__label">Ordenar Por</label></br>
                                <div class="position-relative">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="row justify-content-center">
                                    ...
                                    <a class="ml-4 btn btn--yellow d-flex align-items-center" href="#"><span class="material-icons mr-2">
                                            archive
                            ...
                            <tbody>
                                <?php for ($i = 1; $i <= 4; $i++) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <h3 class=""><stron>Nombre de postulante</stron></h3>
