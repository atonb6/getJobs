                ...
                <div class="col-md-12">
                    <fieldset class="text-center">
                        ...
                        <select class="select select--input" name="area">
                            <option value="value1">Área de empresa</option>
                        ...
                        <select class="select select--input" name="experiencia">
                            <option value="value1">Nivel de experiencia</option>
                            <option value="value2">Junior</option>
                            <option value="value2">Senior</option>
                        </select>
